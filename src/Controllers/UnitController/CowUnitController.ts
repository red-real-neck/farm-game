...
const HUNGER_TIMER: number = 20;

export class CowUnitController implements UnitControllerInterface {
  private _item: FieldItem;
  private _restTime: number = 0;
  private _restHungerTime: number = HUNGER_TIMER;
  ...
  startHungerTimer() {
    let timer;
    this._restHungerTime = HUNGER_TIMER;
    timer = setInterval(() => {
